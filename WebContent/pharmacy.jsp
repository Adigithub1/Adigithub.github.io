...
<body class="nav-md">
					...
					<div id="sidebar-menu" style="margin-top: -20px"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
										...
										<li class="active"><a href="FirstSalesEntryListDet.html" target="search_iframe">Sales Entry</a></li>
										<li><a href="salesreturnsdetailsList446.html" target="search_iframe">Sales
												Returns</a></li>

										<li><a href="FirstPurchaseInvoice.html" target="search_iframe">Purchase Invoice</a></li>
										<li><a href="puchaseReturnsListDetailsFirst.html" target="search_iframe">Purchase
												Returns</a></li>


										<li><a href="details.html" target="search_iframe">Due Patient/Customer</a></li>
										<li><a href="salesReport.html" target="search_iframe">Sales Entry Report</a></li>
										<li><a href="sdkjf.html" target="search_iframe">Sales Entry & Returns Search</a></li>
    ...
    <a href="Login.jsp" input type="button" data-toggle="tooltip" class="glyphicon glyphicon-off" title="Logout" aria-hidden="true"  data-placement="top" data-delay="25" ></a>
			...
			<iframe      src="FirstSalesEntryListDet.html" width="100%"  height="500px"  name="search_iframe" frameborder="0" scrolling="no" onload="resizeIframe(this)"><img src="images1/136276e7e3289cab6fa21190f3b8b0d4 - Copy.png"/></iframe>
			</div>
