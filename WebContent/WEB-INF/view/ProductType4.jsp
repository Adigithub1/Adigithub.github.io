		...
		<div class="container">
			<div class="row">
				<div class="panel panel-primary">
					...
					<form:form id="registerForm" modelAttribute="pt" method="post" action="saveUsertype.html">
					...
					<div class="row" >
						...
						<div class="row">
					        ...
					        <form:input path="name" onkeypress="return alphaOnly(this, event)" required="required" 
					        class="form-control"  maxlength="20" minlength="3" autocomplete="off" />
...
<div class="row">
		...
		<form:label  path="type"> Product Type:</form:label>				
			...
			<form:option path="type" value="" required="required">----Select---</form:option>
