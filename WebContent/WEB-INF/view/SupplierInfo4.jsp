...
<body style="margin-top:10px">
	<form:form id="registerForm" modelAttribute="s" method="post"  
		action="saveUser1SupplierInfo.html">
				...
				<div class="row">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-xs-6">
									<h3 style="color: red; text-align: center;">Supplier Name
										is already exits</h3>
								...
								<div class="col-xs-6">
									<label for="lname">Supplier Code</label> <input type="text"
										class="form-control" name="supCode" readonly="true"
										value="${model.maxId[0]}">
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-6">
									...
									<form:select id="icon_prefix" path="supType" name="card"
										...
										<form:option path="supType" value="" required="required"
											class="form-control">----Select---</form:option>
								...
								<div class="row">
									...
									<div class="col-xs-6">
										<label for="lname">Mobile No(Contact Person)</label>
 ...
 -->
								...
								<div class="row">
									<div class="col-xs-6">
										...
										<form:input path="aggtNum" class="form-control"
											onkeyup = "Validate(this)"  maxlength="10"
									...
									<div class="col-xs-6">
										...
										<div class="input-append date form_datetime">
											<form:input path="aggtDate" id="my1" placeholder="MM-DD-YYYY" class="form-control"
								...
								<div class="row">
									<div class="col-xs-6">
										...
										<form:input path="cstNum" class="form-control"
											 onkeyup = "Validate(this)" maxlength="11"
									...
									<div class="col-xs-6">
										...
										<form:input path="apNum" class="form-control"
											onkeyup = "Validate(this)"  maxlength="15"
											minlength="15" autocomplete="off" 
											onpaste="return false" />
										<!--   <input type="text" class="form-control" name="Patient Name"> -->
									</div>
								</div>
								...
								<div class="row" style="padding-top: 3%; padding-left: 27%">
									...
									<a href="userListSupplier.html" class="btn btn-info"> <span
