...
<body>
<form:form id="registerForm" modelAttribute="ph" method="post" action="savePharmacyForm.html" >
				...
				<div class="panel panel-primary">
					...
					<div class="col-xs-6">
						  ...
						  <form:input path="pharId" readonly="true" value="${model.maxId[0]}"
                           ...
                           <%-- <form:label path="pharNum">Pharmacy Number:</form:label>
								<form:input path="pharNum"
						...
						<div class="row">
                          ...
                          <div class="form-group">
                              ...
                              <form:input path="dlNum" class="form-control"
                   ...
                   <form:label path="address2">Address Line 2</form:label>
                    <div class="controls">
                       <form:input path="address2" class="form-control"
											autocomplete="off"   required="required" maxlength="50" placeholder="address line 2" 
											minlength="3" />
                   ...
                   <form:label path="state">State / Province / Region</form:label>
                    <div class="controls">
                        <form:input path="state" class="form-control"
										onkeypress="return alphaOnly(this, event)" required="required"
										maxlength="30" minlength="3" autocomplete="off"
										onpaste="return false" />
                        <p class="help-block"></p>
                    </div>
                </div>
