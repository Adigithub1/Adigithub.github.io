								...
								<c:forEach items="${abc}" var="abc">
									<tr>
										...
										<td><c:out value="${abc.consultantFee}" /></td>
											<td align="center">  <button><a  style="color:black" href="editoutsideconult.html?id=${abc.id}"><span
												class="glyphicon glyphicon-edit"></a></button></td>
										<td align="center">  <button><a  style="color:black" href="deleteoustsideconsu.html?id=${abc.id}"><span
												class="glyphicon glyphicon-trash"></span></a></button></td>
