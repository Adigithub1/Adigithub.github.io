...
function submitIt() {
    if (document.getElementById('message1').value == ""&&document.getElementById('message2').value == ""&&document.getElementById('datepicker12').value == "") {
    ...
    <div class="panel-body">
					...
					<div class="col-xs-3"></div>
                           ...
                           <label for="lname">Search By Patient Name</label>
                            <input type="text" class="form-control" name="name" placeholder="Enter PatientName" onkeypress="return numberOnly(this, event)"
                           ...
                           <label for="lname">Search By MR.No</label>
							...
							<div class="col-xs-6">
								...
								<div class="input-append date form_datetime">
									<input  name="date"  class="form-control" id="datepicker12" placeholder="DD/MM/YYYY">
									</div>
									</div><div class="col-xs-3"></div>
									</div>
