...
<body style="margin-top: 10px">
	<form:form id="registerForm" modelAttribute="asdf" method="post"
		action="saveSupplierType.html">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body"
							...
							<div class="row">
								...
								<form:input path="supplierType"
									onkeypress="return alphaOnly(this, event)" type="text"
							...
							<div class="row" style="padding-top: 3%">
								<center>
									...
									<a href="userListUOM.html" class="btn btn-info"> <span
