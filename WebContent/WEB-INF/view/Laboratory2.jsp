...
<body>
<form:form id="registerForm" modelAttribute="lab" method="post" action="saveLaboratoryform.html">
					...
					<div class="col-xs-6">
                          ...
                          <form:label path="labId">Laboratory ID:</form:label>
                           ...
                           <form:label path="labName">Laboratory Name:</form:label>
                            ...
                            <form:input path="labNum" class="form-control"
                          ...
                          <form:label path="establish">Year of Establishment:</form:label>
                           ...
                           <form:label path="email">Email</form:label>
									<form:input path="email" name="myForm" class="form-control"
