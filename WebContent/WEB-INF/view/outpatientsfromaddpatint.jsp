			...
			<div class="row">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<label>Out-Patient Enquiry</label>
					</div>
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<form action="serrchpatient1fromadddpaient.html" class="abcd" onSubmit="return submitIt()" >
									<label for="lname">Search By Patient MR.No</label> <input
										type="text" class="form-control" name="mrno" id="regnoss" placeholder="Enter RegistrationNumber"
										onkeypress="return numberOnly1(this, event)" minlength="3"
								...
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<label for="lname">Search By Patient Name</label> <input
											...
											onkeypress="return numberOnly(this, event)" placeholder="Enter PatientName" minlength="3" id="namess"
											maxlength="30" autocomplete="off" name="pname">
									</div><div class="col-xs-3"></div>
								</div>
					...
					<div class="row"
						...
						<center>
							<div class="alert alert-success">Total OutPatients
								[${numbers}]</div>
						</center>
					</div>
					<div class="bs-example">
						<c:if test="${empty abc}">
							<h3 style="color: red;" align="center">NO DATA FOUND</h3>
						</c:if>

						<table class="table table-bordered">
							<thead>
								<tr style="background-color: #337ab7; color: #f9f8f8">
									<th><span class="glyphicon glyphicon-book"></span> Patient
										MR.No</th>
									<th><span class="glyphicon glyphicon-user"></span> Patient
										Name</th>
									<th><span class="glyphicon glyphicon-calendar"></span>
										Registration Date</th>
									<th><span ><i class="fa fa-user-md"></i></span> Doctor</th>
