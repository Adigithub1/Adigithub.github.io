...
<form:form modelAttribute="purchaseInvoiceePojo" method="post"
				...
				<div class="row">
					...
					<div class="col-xs-6">
                       ...
                       <!--  <select class="form-control">
								...
								<form:input path="invoiceNo" required="required" class="form-control" readonly="true" />
 ...
 <!-- <input type="text" class="form-control" name="name"> -->
    ...
    color: #f9f8f8">
               <!--  <th><span class="glyphicon glyphicon-list-alt"></span> Product ID</th> -->
               	<th><span class="glyphicon glyphicon-list-alt"></span> Pro.Name</th>
 ...
 <input type="text" class="form-control" name="name">
   ...
   <a href="canelpurchaseReturnsdetails.html" class="btn btn-info"><span class="glyphicon glyphicon-remove"></span>Cancel</a></center>
