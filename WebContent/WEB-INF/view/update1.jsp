...
<c:url var="userDepart" value="updateUser1.html"/>
		...
		<div class="container">
			<div class="row">
				<div class="panel panel-primary">
					...
					<div class="row">
							<div class="col-xs-6">
							<form:label path="id">DepartmentId</form:label>
							<form:input path="id"  type="text" class="form-control"  required="required" readonly="true"
							minlength="8" maxlength="13"	value="${abc.id}" ></form:input>
                           
                            </div>
					<div class="row">
							<div class="col-xs-6">
							<form:label path="departmentName">DepartmentName</form:label>
							...
							<form:select path="maindepartmentName"  items="${maindept}" class="form-control" id="sel1"></form:select>
							 
							</div>
							<div class="row">
							<div class="col-xs-6">
							<form:label path="location">Location</form:label>
							<form:select path="location"  items="${location}" class="form-control" id="sel1"></form:select>
