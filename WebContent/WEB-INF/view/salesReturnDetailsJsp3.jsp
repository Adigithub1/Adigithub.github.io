								...
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<form:input path="salesType" required="required"
											readonly="true" class="form-control" value="${xyz.salesType}" />
									</div>
								</div>
								...
								<thead>
									...
									<tr
										...
										<td><form:input   style="width:100px" path="salesQty" required="required"
												id="kx1" class="form-control" onchange="getValue()" type="number" min="1" max="${qty[0]}"/></td>
										<td><form:input   style="width:100px" path="utRate" required="required"
												readonly="true" value="${abc.utRate}" id="kx2"
												class="form-control" /></td>
										<td><form:input path="value"  style="width:100px" required="required"
												class="form-control" readonly="true" value="" id="kx3" /></td>
										<td><form:input path="discount"  style="width:100px" required="required"
												type="number" step="0.1" id="kx4"
												onchange="getsubDiscount()" class="form-control" min="0"
												max="99" /></td>
										<td><form:input path="amount" style="width:100px" required="required"
