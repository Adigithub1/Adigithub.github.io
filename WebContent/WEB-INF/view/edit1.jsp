...
<body style="margin-top:10px">
	<form:form method="post" action="update.html" commandName="patient1">
				...
				<div class="row">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="RegistNo" class="form-control"
										value="${s1}" readonly="true" required="required" />
								</div>
								...
								<div class="col-xs-6">
									...
									<form:input path="PatientName" class="form-control" onkeypress="return numberOnly(this, event)"
										minlength="3" maxlength="30" autocomplete="off" id="message1"
										value="${s2}" required="required" />
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="Occupation" class="form-control" onkeypress="return numberOnly(this, event)" id="message2"
								...
								<div class="row">
									<div class="col-xs-6">
										...
										<form:input path="GourdenName" class="form-control" id="message3" onkeypress="return numberOnly(this, event)"
										minlength="3" maxlength="30" autocomplete="off"
							...
							<div class="row">
								...
								<div class="col-xs-6">
									...
									<form:input path="Age" id="Mobile_Number" class="form-control"
								...
								<div class="col-xs-6" style="padding-top: 2%">
									...
									<form:select path="Sex" required="required">

										<form:option value="${s6}">${s6}</form:option>
								...
								<div class="col-xs-6">
									...
									<div class="row">
										...
										<form:input path="Phone" id="Mobile_Number"
											...
											onkeypress="return isNumber(event)" minlength="8"
											maxlength="10"
											onkeyup="allnumeric(document.form1.MobileNumber);"
                     ...
                     <form:label path="Remarks" for="lname">Remarks</form:label>
										<%-- 	<form:input path="Remarks" value="${s7}" class="form-control"/> --%>
							<%-- 			<form:label path="Remarks" for="lname">Remarks</form:label>
										<form:textarea path="Remarks" class="form-control" rows="3"
											value="${s7}" required="required" /> --%>
 ...
 ${s7}
							...
							<div class="row" >
								<div class="col-xs-6">
									...
									<div class="control-group">
										...
										<form:input path="Address" required="required" value="${s17}"
								...
								<div class="col-xs-6">
									...
									<div class="control-group">
										...
										<form:input path="Address1"  value="${s9}"
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="city" class="form-control" placeholder="city"  onkeypress="return numberOnly12(this, event)"
										minlength="3" maxlength="30" autocomplete="off" id="message11"
								...
								<div class="col-xs-6">
									<div class="control-group">
										...
										<form:input path="Pincode" id="Mobile_Number"
											required="required" onkeypress="return isNumber(event)"
											value="${s11}" placeholder="zip or postal code" minlength="1"
											maxlength="6" />
							...
							<div class="row">
								<div class="col-xs-6">
									<div class="control-group">
										...
										minlength="3" maxlength="30" autocomplete="off" id="message13"
											value="${s12}" required="required" />
										<p class="help-block"></p>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select id="country" name="country" class="form-control" required="required" >
												<option value="${s13}" selected="selected">${s13}</option>
									...
									<div class="panel-body">
										<div class="row">
											...
											<div class="col-xs-6">
												...
												<form:select path="DoctorName" class="form-control"
													...
													<form:option value="${s14}">${s14}</form:option>
										...
										<div class="row">
											...
											<div class="col-xs-6">
												...
												<form:input path="appointDate"  value="${appoint1}" class="form-control" onchange="this.form.submit()" id="datepicker" placeholder="DD/MM/YYYY" required="required"/>
	...
	<a href="index1.html">SearchPatient</a>
	<script type="text/javascript">
