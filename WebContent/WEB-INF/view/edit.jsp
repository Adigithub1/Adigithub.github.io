...
<script type="text/javascript">
        function numberOnly(txt, e) {
            ...
            if (arr.indexOf(char) == -1)
                return false;
            document.getElementById("message1as").onkeypress=function(e){
	...
	<form:form method="post" action="update.html" commandName="patient">
		<div class="container-fluid">
			<div class="container">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="RegistNo" class="form-control" value="${xyz.registNo}" readonly="true"
										required="required" />
								</div>
								...
								<div class="col-xs-6">
									...
									<form:input path="PatientName" onkeypress="return numberOnly(this, event)" id="message1"
										minlength="3" maxlength="30" autocomplete="off" class="form-control" value="${xyz.patientName}"
										required="required" />
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="Occupation"  onkeypress="return numberOnly(this, event)" id="message2"
										minlength="3" maxlength="30" autocomplete="off" class="form-control" value="${xyz.occupation}"
										required="required" />
									...
									<div class="col-xs-6">
										...
										<form:input path="GourdenName" onkeypress="return numberOnly(this, event)" id="message3"
										minlength="3" maxlength="30" autocomplete="off" class="form-control" value="${xyz.gourdenName}"
											required="required" />
									</div>
				...
				<form:input path="Age" id="Mobile_Number" class="form-control" value="${xyz.age}" 
								required="required" onkeypress="return isNumber(event)"
								minlength="1" maxlength="3" 
								onkeyup="allnumeric(document.form1.MobileNumber);" autocomplete="off"/>		
				...
				<form:input path="Phone" id="Mobile_Number" class="form-control" value="${xyz.phone}"
								required="required" onkeypress="return isNumber(event)"
								...
								<div class="col-xs-6">
										...
										<form:input path="RegistDate"  readonly="true"
											class="form-control" value="${xyz.registDate}" placeholder="DD/MM/YYYY"
											required="required" />
...
<div class="row" style="padding-left:4%;padding-right:4%">
								...
								<form:input path="Address" required="required" placeholder="address line 1" value="${xyz.address}" class="form-control" />
								...
								<form:input path="Address1"  placeholder="address line 2" value="${xyz.address1}" class="form-control" />
								<p class="help-block">				
								...
								<div class="col-xs-6">
									<div class="form-group">
											...
											<form:label path="Remarks" for="lname">Remarks</form:label>
												...
												name="remarks" id="message8" >
 ${xyz.remarks}
</textarea>
										<%-- <form:textarea path="Remarks" class="form-control" rows="3"
											value="${rem}"  required="required" ></form:textarea> --%>
						<%-- 		<form:label path="Remarks" for="lname">Remarks</form:label>
				<form:textarea path="Remarks"  class="form-control" rows="3"   required="required"></form:textarea>	 --%>
<%-- 				<label for="lname">Remarks</label>
				<textarea rows="3"  class="form-control" name="remark" value="${xyz.remarks}" >${xyz.remarks}</textarea>  --%>
				...
				<form:input path="city" class="form-control" placeholder="city" onkeypress="return numberOnly1(this, event)"
										minlength="3" maxlength="30" autocomplete="off" value="${xyz.city}"  required="required" />
				...
				<form:input class="form-control" path="Pincode" id="Mobile_Number"
								required="required" onkeypress="return isNumber(event)" value="${xyz.pincode}" placeholder="zip or postal code"
				...
				<form:input path="State" placeholder="state / province / region" class="form-control" onkeypress="return numberOnly(this, event)"
										minlength="3" maxlength="30" autocomplete="off" value="${xyz.state}"  required="required"/>		
											<p class="help-block"></p>
								...
								<div class="col-xs-6">
									<div class="control-group">
										...
										<div class="controls">
											<select id="country" name="country" class="form-control" value="${count}" required="required" >
											...
											<option>Afghanistan</option>
												...
												<option >Korea, Democratic People's
													Republic of</option>
												...
												<option >Macau</option>
												<option >Macedonia, The Former Yugoslav
													Republic of</option>
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-xs-6">
												...
												<input type="text" value="${xyz.tokenNo}"  readonly="true" > --%>
												
												<form:label path="tokenNo" for="lname">Token No</form:label>
												<form:input path="tokenNo" class="form-control"
													value="${xyz.tokenNo}" readonly="true" required="required" />

											</div>
											<div class="col-xs-6">
							
			<form:label path="DoctorName">Doctor Name</form:label>
					<form:select path="DoctorName" class="form-control" onchange="this.form.submit()" autocomplete="off" required="required">
					...
					<form:select path="RegFee" class="form-control"   required="required">
					
					<form:option value="${dfee}">${dfee}</form:option>
					<form:options items="${fee}" />
					
					</form:select></td>
											</div>
											<div class="col-xs-6">
											<form:label path="appointDate">AppointDate</form:label>
												<form:input path="appointDate"  value="${xyz.appointDate}" class="form-control" onchange="this.form.submit()" id="datepicker" placeholder="DD/MM/YYYY" required="required"/>
<%-- 				<label>Appointment Date</label> <input type="date"
													onchange="this.form.submit()" name="data1"
													class="form-control" placeholder="DD/MM/YYYY"
													autocomplete="off" value="${xyz.appointDate}"> --%>
									...
									<div class="row" style="margin-top: 3%; margin-bottom: 3%"
										...
										<button type="submit" class="btn btn-info" name="updatedata">
