...
">
  					...
  					<div class="form-group">
										...
										<form:radiobuttons style="margin:3px" path="gender" items="${gr}"
											required="required" />
                    ...
                    <div class="control-group">
												...
												<div class="controls">
													<form:input path="Address" type="text"
														required="required" id="address-line1"
     ...
     <form:label path="Treatmentfor">Treatment for</form:label>
												<form:textarea path="Treatmentfor" rows="2" cols="20"
													id="Treatment for" minlength="" maxlength="30"
													class="form-control"
                   ...
                   <form:label path="Address2">Address2</form:label>
												<div class="controls">
													<form:input path="Address2" type="text"
														required="required" id="address-line2" minlength="5"
														maxlength="10" placeholder="address line 2"
