...
<body style="margin-top: 50px" onload="myclear()">
  ...
  <form action="search.html" >
    <div class="row">
					...
					<div class="col-xs-3"></div>
                           ...
                           <label for="lname">Search By Patient Name</label>
                            <input type="text" class="form-control" maxlength="30" name="pname"  name="textField" onkeypress="return numberOnly(this, event)" id="message1" >
                            </div>
                            	<div class="col-xs-3"></div>
                         ...
                         <div class="col-xs-6">
                           ...
                           <label for="lname">Search By MR.No</label>
                            <input type="text" class="form-control" maxlength="30" name="pmrnum"  onkeypress="return numberOnly1(this, event)" id="message2">
      ...
      <span class="glyphicon glyphicon-search"></span> Search
    					...
    					<button  type="submit" class="btn btn-info" class="sendButton">
     <a style="color:white;text-decoration:none" href="InpatientReport.html"> <span class="glyphicon glyphicon-list"></span> Report  </a>
    </button>
  </center>
   ...
   <div class="bs-example" style="padding-left:3%;padding-right:3%">
    ...
    color: #f9f8f8">
                <th><span class="glyphicon glyphicon-book"></span> Patient MR.No</th>
               <!--  <th><span class="glyphicon glyphicon-tags"></span> Patient No</th> -->
                ...
                <th><span class="glyphicon glyphicon-calendar"></span> Admission Date</th>
        ...
        <c:forEach items="${abc}" var="abc">
				<%-- <tr><td>Total<c:out value="${abc.id}"></c:out></td></tr> --%>
					...
					<td><c:out value="${abc.patientmrno}" /></td>
					  ...
					  <td><form action="updatedinpatient.html?id=${abc.id}" method="post">
					  <input type="hidden" name="mrno" value="${abc.patientmrno}">
					   <button  class="btn btn-info" onclick="return confirmAction();">    <span class="glyphicon glyphicon-edit" ></span></button>
								<!-- <input type="submit" value="Edit"  onclick="return confirmAction();" class="submitClass" /> -->
								<td> <button class="btn btn-info"><span class="glyphicon glyphicon-print"></span></button></td>
							</form></td>  
