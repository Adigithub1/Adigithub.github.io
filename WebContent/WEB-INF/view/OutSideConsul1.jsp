				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
							...
							<form:form  action="outSideConsuAdd.html">
							...
							<div class="col-xs-3"> 
							<label style="padding-top:3%;align:right">Search By Name</label></div>
...
<input type="text" class="form-control" name="namecon" onkeypress="return numberOnly(this, event)"  id="message1" placeholder="Enter Consultant Name"
  ...
  <%--  <form:form action="outsideconsultReport.html" modelAttribute="user">
    ...
    <button type="submit" class="btn btn-info">
     <a style="color:white;text-decoration:none" href="outsideconsultReport.html"> <span class="glyphicon glyphicon-list-alt"></span> Report</a>
    </button>
  <%--   </form:form> --%>
					</div>
							  </form>
...
<div class="row"
						...
						<center>
							<div class="alert alert-success">Total  Out-Patients
								[${patints}]</div>
						</center>
					</div>
