...
<body style="margin-top:10px">
	<form:form method="post" action="savemlc.html" commandName="mlcpatient" enctype="multipart/form-data">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="registrationNumber" class="form-control" value="${mlcregno}" readonly="true"
										required="required" />
								...
								<div class="col-xs-6">
									...
									<form:input path="patientName" class="form-control" placeholder="Enter PatientName"  onkeypress="return numberOnly(this, event)" id="message1"
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<form:input path="occupation" class="form-control" placeholder="Enter Occupation"  onkeypress="return numberOnly(this, event)" id="message2"
										minlength="3" maxlength="20" autocomplete="off"
										required="required" />	
									...
									<form:input path="guardiansName" class="form-control" placeholder="Enter Guardian's Name" onkeypress="return numberOnly(this, event)" id="message3"
										minlength="3" maxlength="20" autocomplete="off"
										required="required" />		
							...
							<div class="row">
								...
								<div class="col-xs-6">
									...
									<form:input path="phoneNumber" class="form-control" placeholder="Enter PhoneNumber"
										required="required"
...
<div class="row" style="margin-top:3%">
									<div class="form-group">
										...
										<form:label path="sex" class="col-xs-3">Gender</form:label>
									<form:radiobuttons path="sex" items="${radiobutt}"
										required="required" />	
										</div>
										</div>
										...
										<form:input path="regdate" id="Appointment"
											class="form-control" value="${time}" placeholder="DD/MM/YYYY" readonly="true"
											required="required" />
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-xs-6">
									<div class="form-group">
										...
										<form:textarea path="identification1" class="form-control" rows="3" onkeypress="return numberOnly1(this, event)" id="message6"
										minlength="3" maxlength="40" autocomplete="off" placeholder="Enter Identification 1"
											required="required" />
									</div>
								</div>
								<div class="col-xs-6">
									<div class="form-group">
										...
										<form:textarea path="identification2" class="form-control" rows="3" onkeypress="return numberOnly1(this, event)" id="message7"
										minlength="3" maxlength="40" autocomplete="off" placeholder="Enter Identification 2"
											required="required" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="control-group">
										...
										<form:input path="addressLine1" required="required"
					...
					<form:label path="addressLine2" class="control-label">Address Line 2</form:label>
										<form:input path="addressLine2" required="required"
											placeholder="address line 1" class="form-control" />
							...
							<form:label path="city" class="control-label">City / Town</form:label>
									<form:input path="city" class="form-control" placeholder="city"  onkeypress="return numberOnly(this, event)"
										minlength="3" maxlength="20" autocomplete="off" id="message8"
										required="required" />
								...
								<div class="col-xs-6">
									<div class="control-group">
										...
										<form:input path="pincode1"  class="form-control" id="Mobile_Number"
											required="required" onkeypress="return isNumber(event)"
							...
							<div class="row">
								<div class="col-xs-6">
									...
									<form:label path="state" class="control-label">State / Province / Region</form:label>
										...
										minlength="3" maxlength="20" autocomplete="off" id="message11"
											required="required" />
									</div>
								</div>
									 ...
									 <div class="form-group">
										...
										<div class="input-group col-xs-12">
											<span class="input-group-addon"><i
												class="glyphicon glyphicon-picture"></i></span> <input type="text" id="immm"
