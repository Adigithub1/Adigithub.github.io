    ...
    <div class="panel-body">
					...
					<form action="index2.html" class="abcd" onSubmit="return submitIt()">		
                           <label for="lname">Search By Patient Name</label>
                            <input type="text" class="form-control"  onkeypress="return numberOnly(this, event)" placeholder="Enter PatientName" name="name" id="namess">
                         ...
                         <div class="col-xs-6">
                           ...
                           <label for="lname">Search By MR.No</label>
                            <input type="text" class="form-control" placeholder="Enter RegistrationNumber" onkeypress="return numberOnly1(this, event)" name="regno" id="regnoss">
