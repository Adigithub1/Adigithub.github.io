					...
					<div class="row" >
						...
						<div class="row">
							<form:label path="unitName">Unit Name:</form:label>
								<form:input path="unitName" onkeypress="return alphaOnly(this, event)" type="text" required="required"  class="form-control" maxlength="20" minlength="2" autocomplete="off" />
