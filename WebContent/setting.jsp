...
<body class="nav-md">
					...
					<div id="sidebar-menu" style="margin-top: -20px"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
										...
										<li class="active"><a href="userListHospital.html" target="search_iframe">Hospital Details</a></li>
    ...
    <a href="Login.jsp" input type="button" data-toggle="tooltip" class="glyphicon glyphicon-off" title="Logout" aria-hidden="true"  data-placement="top" data-delay="25" ></a>
			...
			<iframe src="userListHospital.html"  frameborder="0"  scrolling="no" onload="resizeIframe(this)" style="padding-top:10px"  width="100%" height="700px" name="search_iframe"><img src="136276e7e3289cab6fa21190f3b8b0d4 - Copy.png" width=800px height=800px/></iframe>
			</div>
