...
<body class="nav-md">
					...
					<div id="sidebar-menu" style="margin-top: -20px"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
										...
										<li class="active"><a href="doctor.html" target="search_iframe">Doctor Information</a></li>
									
										<li><a href="outconsult.html" target="search_iframe">Outside Consultant Tariff</a></li>
    ...
    <a href="Login.jsp" input type="button" data-toggle="tooltip" class="glyphicon glyphicon-off" title="Logout" aria-hidden="true"  data-placement="top" data-delay="25" ></a>
			...
			<iframe style="padding-top:10px" src="doctor.html" width="100%"  frameborder="0" scrolling="no" onload="resizeIframe(this)" height="700px" name="search_iframe"><img src="images1/136276e7e3289cab6fa21190f3b8b0d4 - Copy.png"/></iframe>
			</div>
