...
<body class="nav-md">
					...
					<div id="sidebar-menu" style="margin-top: -20px"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
										...
										<li class="active"><a href="roomDetails.html" target="search_iframe">Room Type</a></li>
										<li><a href="bedDetails.html" target="search_iframe">Bed Type</a></li>
										<li><a href="showtarrif.html" target="search_iframe">Room Tariff</a></li>
										<li><a href="firstBedTypePage.html" target="search_iframe">Bed Details</a></li>
    ...
    <a href="Login.jsp" input type="button" data-toggle="tooltip" class="glyphicon glyphicon-off" title="Logout" aria-hidden="true"  data-placement="top" data-delay="25" ></a>
			...
			<iframe style="padding-top:1px"  frameborder="0"  scrolling="no" onload="resizeIframe(this)"src="roomDetails.html" width="100%" height="700px" name="search_iframe"><img src="images1/136276e7e3289cab6fa21190f3b8b0d4 - Copy.png"/></iframe>
			</div>
