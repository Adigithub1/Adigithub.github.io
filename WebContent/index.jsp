	...
	<div class="container body">
		<div class="main_container">
				...
				<div class="left_col scroll-view"
								...
								<li><a><i class="fa fa-medkit"></i> Pharmacy <span
									...
									<ul class="nav child_menu">
										...
										<li><a href="salesreturnsdetailsList446.html"
											target="search_iframe">Sales Returns</a></li>
										...
										<li><a href="salesReport.html" target="search_iframe">Sales
												Entry Report</a></li>
					...
					<div class="sidebar-footer hidden-small">
						...
						<a href="lockScreen.html?username=${userName[0]}" input
							...
							data-placement="top" data-delay="25"></a> <a href="Login.jsp"
							input type="button" data-toggle="tooltip"
			...
			<div class="right_col" role="main" width="100%" height="auto">
				<iframe src="image.jsp" width="100%"    name="search_iframe" frameborder="0" scrolling="no" onload="resizeIframe(this)">
