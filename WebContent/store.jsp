...
<body class="nav-md">
					...
					<div id="sidebar-menu" style="margin-top: -20px"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
										...
										<li class="active"><a href="userListUOM.html" target="search_iframe">UOM</a></li>
										<li><a href="userListProductType.html" target="search_iframe">Product Type</a></li>
										<li><a href="userListProductDetail.html" target="search_iframe">Product
												Details</a></li>
										<li><a href="stockdetails.html" target="search_iframe">Stock Position</a></li>
										<li><a href="userList4.html" target="search_iframe">Packing Information</a></li>
										<li><a href="stockdetails12345.html" target="search_iframe">Stock
												Adjustments</a></li>
										<li><a href="userListSupplier.html" target="search_iframe">Supplier
												Information</a></li>
    ...
    <a href="Login.jsp" input type="button" data-toggle="tooltip" class="glyphicon glyphicon-off" title="Logout" aria-hidden="true"  data-placement="top" data-delay="25" ></a>
			...
			<iframe style="padding-top:10px" src="userListUOM.html"  frameborder="0" scrolling="no" onload="resizeIframe(this)" width="100%" height="700px" name="search_iframe"><img src="images1/136276e7e3289cab6fa21190f3b8b0d4 - Copy.png"/></iframe>
			</div>
