...
<body class="nav-md">
	...
	<center>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav" class="menus"
				...
				<li class="menus"><a href="billing.jsp"
					style="color: white !important; padding: 12px 55px 0px 55px;"
					data-toggle="tooltip" title="Billing"><i class="fa fa-rupee"></i></a></li>
					...
					<div id="sidebar-menu" style="margin-top: -20px"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
										...
										<li><a href="userListHospital.html" target="search_iframe">Hospital Details</a></li>
										<li><a href="userListLaboratory.html" target="search_iframe">Lab Details</a></li>
										<li><a href="userListPharmacy.html" target="search_iframe">Pharmacy Details</a></li>
										<li><a href="indexxv.html" target="search_iframe">Location Details</a></li>
										<li><a href="indexxv1.html" target="search_iframe">Department Details</a></li>

										<li><a href="sdkjf.html" target="search_iframe">Operation Theater</a></li>
										<li><a href="sdkjf.html" target="search_iframe">Disease Details</a></li>
										<li><a href="sdkjf.html" target="search_iframe">Add Employee</a></li>
    ...
    <a href="Login.jsp" input type="button" data-toggle="tooltip" class="glyphicon glyphicon-off" title="Logout" aria-hidden="true"  data-placement="top" data-delay="25" ></a>
				...
				<div class="nav_menu" style="background-color: white">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class=""><a href="javascript:;"
							...
							aria-expanded="false"> <img src="" alt="">Shwetha <span
			...
			<iframe style="padding-top:10px" src="" width="100%" height="700px" name="search_iframe"><img src="images1/136276e7e3289cab6fa21190f3b8b0d4 - Copy.png"/></iframe>
			</div>
