...
public class ProductController {
	...
	public ModelAndView loginapplication(@ModelAttribute("register") RegisterPojo register, BindingResult result) {
	...
	public ModelAndView loginapplicationSecond(@ModelAttribute("register") RegisterPojo register,
		...
		if (isValid) {
			...
			return new ModelAndView("redirect:/loginapplicationPasswordWrong.html");
		}
	}

	@RequestMapping("/lockScreenApplicationinapplicationSecond")
	public ModelAndView lockScreenApplicationinapplicationSecond(@ModelAttribute("register") RegisterPojo register,
			BindingResult result) {
		System.out.println("am in first time in controller");
	...
	public ModelAndView lockScreen(@ModelAttribute("register") RegisterPojo register, BindingResult result) {
		System.out.println("am in first time in controller");
		ArrayList<String> userName = new ArrayList<String>();
		userName.add(register.getUsername());
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView loginapplicationPasswordWrong(@ModelAttribute("register") RegisterPojo register,
			BindingResult result) {
		System.out.println("am in first time in controller");
	...
	public ModelAndView getRegisterForm(@ModelAttribute("p") Product p, BindingResult result) {
	...
	/*
	 * @RequestMapping("/userList") public ModelAndView
	 * getUser1(@ModelAttribute("p") Product p, BindingResult result) {
	 * System.out.println("am in first step controller"); return new
	 * ModelAndView("display"); }
	 */
	@RequestMapping(value = "/userListUOM")
	public ModelAndView getUser(@ModelAttribute("p") Product p, BindingResult result) {
	...
	public ModelAndView saveUserData(@ModelAttribute("p") Product p, BindingResult result) {

		/*
		 * productService.saveProduct(p); System.out.println("Save User Data");
		 * System.out.println(p.getUnitName()); return new
		...
		if (isValidUser) {
			...
			return new ModelAndView("redirect:/userListUOM.html");
		}

	}

	@RequestMapping(value = "/updateUOM")
	public ModelAndView UpdateGet(@ModelAttribute("p") Product p, BindingResult result) {
		...
		for (Integer[] s : id) {
			...
			for (int j = 0; j < i; j++) {
				...
				System.out.println("am in controller retrive for each cusomerName");
			}
		}
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("p") Product p, BindingResult result) {
		productService.updateProduct(p);
		return new ModelAndView("redirect:/afterUpdateuserListUOM.html");
	}

	@RequestMapping(value = "/afterUpdateuserListUOM")
	public ModelAndView afterUpdateuserListUOM(@ModelAttribute("p") Product p, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("p", productService.listProduct());

		ArrayList<String> updateMsg = new ArrayList<String>();
		updateMsg.add("RECORDS UPDATED SUCCESSFULLY");
	...
	public ModelAndView deleteEmployee(@ModelAttribute("p") Product p, BindingResult result) {
	...
	public ModelAndView aftedeleteuserListDom(@ModelAttribute("p") Product p, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("p", productService.listProduct());

		ArrayList<String> updateMsg = new ArrayList<String>();
		updateMsg.add("RECORDS DELETED SUCCESSFULLY");
		model.put("updateMsg", updateMsg);
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("p") Product p, BindingResult result) {
	...
	public ModelAndView getRegisterForm(@ModelAttribute("pac") Packing pac, BindingResult result) {
	...
	public ModelAndView getUser(@ModelAttribute("pac") Packing pac, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pac", packingService.listPacking());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("pac") Packing pac, BindingResult result) {

		boolean isValidUser = packingService.savePacking(pac);
		if (isValidUser) {
			return new ModelAndView("PackingDetails4");
		} else {
			return new ModelAndView("redirect:/userList4.html");
		}
	}
	...
	public ModelAndView UpdateGet(@ModelAttribute("pac") Packing pac, BindingResult result) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("pac") Packing pac, BindingResult result) {
	...
	public ModelAndView afterupdatingUserList(@ModelAttribute("pac") Packing pac, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pac", packingService.listPacking());
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("pac") Packing pac, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView deleteEmployee(@ModelAttribute("pac") Packing pac, BindingResult result) {
		System.out.println("im in deleted controler");
	...
	public ModelAndView afterdeleteingUserList(@ModelAttribute("pac") Packing pac, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pac", packingService.listPacking());
	...
	public ModelAndView getRegisterForm(@ModelAttribute("pt") ProductType pt, BindingResult result) {
		System.out.println("am in first step controller");
		System.out.println("Register Form");
	...
	@RequestMapping(value = "/userListProductType")
	public ModelAndView getUser(@ModelAttribute("pt") ProductType pt, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pt", productTypeService.listProduct1());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("pt") ProductType pt, BindingResult result) {

		/*
		 * productTypeService.saveProduct1(pt); System.out.println(
		 * "Save User Data"); System.out.println(pt.getName()); return new
		 * ModelAndView("redirect:/userListProductType.html");
		 */
		ArrayList<String> card = new ArrayList<String>();
		card.add("Drug");
		card.add("General");
		...
		if (isValidUser) {
			...
			return new ModelAndView("redirect:/userListProductType.html");
		}
	...
	public ModelAndView UpdateGet(@ModelAttribute("pt") ProductType pt, BindingResult result) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("pt") ProductType pt, BindingResult result) {
		productTypeService.updateProduct1(pt);
		return new ModelAndView("redirect:/afterUserListProductTypeUpdateProductType1.html");

	}

	@RequestMapping(value = "/afterUserListProductTypeUpdateProductType1")
	public ModelAndView afterUserListProductTypeUpdateProductType1(@ModelAttribute("pt") ProductType pt,
			BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pt", productTypeService.listProduct1());
	...
	public ModelAndView afterUserListProductTypeDeleteProductType1(@ModelAttribute("pt") ProductType pt,
			BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pt", productTypeService.listProduct1());
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("pt") ProductType pt, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView deleteEmployee(@ModelAttribute("pt") ProductType pt, BindingResult result) {
		System.out.println("im in deleted controler");
		...
		System.out.println("delete Employee");
		return new ModelAndView("redirect:/afterUserListProductTypeDeleteProductType1.html");
	}
	...
	public ModelAndView getRegisterForm(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		System.out.println("am in first step controller");
		System.out.println("Register Form");
	...
	public ModelAndView getUser(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pd", productDetailService.listProductDetail());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {

		/*
		 * productDetailService.saveProductDetail(pd); System.out.println(
		 * "Save User Data"); System.out.println(pd.getProName()); return new
		 * ModelAndView("redirect:/userListProductDetail.html");
		 */
		ArrayList<String> VATTAX = new ArrayList<String>();
		VATTAX.add("5");
		VATTAX.add("14");
		...
		if (isValidUser) {
			...
			return new ModelAndView("redirect:/userListProductDetail.html");
		}
	...
	public ModelAndView UpdateGet(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		...
		for (Integer[] s2 : id) {
			...
			for (int j = 0; j < i; j++) {
				...
				System.out.println("am in controller retrive for each supplierName");
			}
		}
		...
		System.out.println(pd.getProCode());
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("update", productDetailService.getProductDetail(pd.getProCode()));
		model.put("pd", productDetailService.listProductDetail());
		model.put("MyFormType2", productDetailService.listMyform());
		model.put("MyFormPack2", productDetailService.listMyform2());
		model.put("MyFormUnit2", productDetailService.listMyform3());
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {

		productDetailService.updateProductDetail(pd);

		return new ModelAndView("redirect:/afterUserListProductdetailupdate.html");

	}

	@RequestMapping(value = "/afterUserListProductdetailupdate")
	public ModelAndView afterUserListProductdetailupdate(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pd", productDetailService.listProductDetail());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView afterUserListProductdetaildelete(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("pd", productDetailService.listProductDetail());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView deleteEmployee(@ModelAttribute("pd") ProductDetail pd, BindingResult result) {
		System.out.println("im in deleted controler");
		...
		System.out.println("delete Employee");
		return new ModelAndView("redirect:/afterUserListProductdetaildelete.html");
	}
	...
	public ModelAndView getRegisterForm(@ModelAttribute("s") Supplier s, BindingResult result) {
		System.out.println("am in first step controller");
		System.out.println("Register Form");
	...
	public ModelAndView getUser(@ModelAttribute("s") Supplier s, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("s", supplierService.listSupplier());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("s") Supplier s, BindingResult result) {

		/*
		 * supplierService.saveSupplier(s); System.out.println("Save User Data"
		 * ); System.out.println(s.getSupName()); return new
		 * ModelAndView("redirect:/userListSupplier.html");
		 */
		ArrayList<String> card = new ArrayList<String>();
		card.add("Drug");
		card.add("Pharmacy");
		...
		if (isValidUser) {
			...
			return new ModelAndView("redirect:/userListSupplier.html");
		}
	...
	public ModelAndView UpdateGet(@ModelAttribute("s") Supplier s, BindingResult result) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("s") Supplier s, BindingResult result) {
	...
	public ModelAndView afterupdateuserlistsupplier(@ModelAttribute("s") Supplier s, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("s", supplierService.listSupplier());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView afterDeleteuserlistsupplier(@ModelAttribute("s") Supplier s, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("s", supplierService.listSupplier());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("s") Supplier s, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView deleteEmployee(@ModelAttribute("s") Supplier s, BindingResult result) {
		System.out.println("im in deleted controler");
	...
	public ModelAndView viewRoomDetails(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
		...
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("rooms", roomService.GetParticularRoomDetails(roomtype.getRoomtypename()));
	...
	public ModelAndView RoomTypeAdd(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
	...
	public ModelAndView RoomTypeSave(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
		roomService.saveRoomDetails(roomtype);
		Map<String, Object> model = new HashMap<String, Object>();
		ArrayList<String[]> names = new ArrayList<String[]>();
		names.add(roomService.getRoomTypes());
		ArrayList<String> names1 = new ArrayList<String>();
	...
	public ModelAndView RoomTypeEdit(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
	...
	public ModelAndView RoomUpDate(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
	...
	public ModelAndView RoomDelete(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
	...
	public ModelAndView searchbyproduct(@ModelAttribute("roomtype") RoomTypePojo roomtype, BindingResult result) {
		...
		map.put("rooms", roomService.GetParticularRoomDetails(roomtype.getRoomtypename()));
	...
	public ModelAndView ShowTarrif(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {
	...
	public ModelAndView getTarifDetalis(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {
	...
	public ModelAndView SaveTarrif(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {

		tarrifService.SaveTarrifDetails(tarrif);

		return new ModelAndView("redirect:/showtarrif.html");

	}

	@RequestMapping("/tarrifEdit")
	public ModelAndView EditTarrif(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {
	...
	public ModelAndView BedUpDate(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {

		System.out.println(tarrif.getTno());
		System.out.println(tarrif.getTno());
		System.out.println(tarrif.getTno());
		System.out.println(tarrif.getTno());
		System.out.println(tarrif.getTno());
	...
	public ModelAndView RoomDelete(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result) {
	...
	public ModelAndView ShowBedDetails(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {
	...
	public ModelAndView BedTypeAdd(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {
	...
	public ModelAndView BedTypeSave(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {
		bedService.saveBedDetails(bedtype);
	...
	public ModelAndView BedEdit(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {
	...
	public ModelAndView BedUpDate(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {

		bedService.UpdateRooms(bedtype);
		return new ModelAndView("redirect:/bedDetails.html");
	}

	@RequestMapping("/bedDelete")
	public ModelAndView BedDelete(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {
	...
	public ModelAndView searchbyproduct(@ModelAttribute("bedtype") BedTypepojo bedtype, BindingResult result) {
		...
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("beds", bedService.GetParticularRoomDetails(bedtype.getBtypename()));
	...
	public ModelAndView getRegisterForm(@ModelAttribute("h") Hospital h, BindingResult result) {
		System.out.println("am in first step controller");
		System.out.println("Register Form");
	...
	public ModelAndView getUser(@ModelAttribute("h") Hospital h, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("h", hospitalService.listDetail());
		System.out.println(model);
	...
	public ModelAndView getUser2(@ModelAttribute("h") Hospital h, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("h", hospitalService.listDetail());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("h") Hospital h, BindingResult result) {
		hospitalService.saveDetail(h);
		System.out.println("Save User Data");
		System.out.println(h.getHosptName());
		return new ModelAndView("redirect:/userListHospitalDetail.html");
	...
	public ModelAndView UpdateGet(@ModelAttribute("h") Hospital h, BindingResult result) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("h") Hospital h, BindingResult result) {

		hospitalService.updateDetail(h);

		return new ModelAndView("redirect:/ofterUpdateuserlistHospitaldeatail.html");

	}

	@RequestMapping(value = "/ofterUpdateuserlistHospitaldeatail")
	public ModelAndView ofterUpdateuserlistHospitaldeatail(@ModelAttribute("h") Hospital h, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("h", hospitalService.listDetail());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("h") Hospital h, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView getRegisterForm(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
		System.out.println("am in first step controller");
		System.out.println("Register Form");
	...
	public ModelAndView getUser(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("lab", laboratoryService.listLaboratory());
		System.out.println(model);
	...
	public ModelAndView getUser2(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("lab", laboratoryService.listLaboratory());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
	...
	public ModelAndView UpdateGet(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
	...
	public ModelAndView afterUpdation(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("lab", laboratoryService.listLaboratory());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("lab") Laboratory lab, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView getRegisterForm(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
		System.out.println("am in first step controller");
		System.out.println("Register Form");
	...
	public ModelAndView getUser(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("ph", pharmacyService.listPharmacy());
		System.out.println(model);
	...
	public ModelAndView getUser2(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("ph", pharmacyService.listPharmacy());
		System.out.println(model);
	...
	public ModelAndView saveUserData(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
	...
	public ModelAndView UpdateGet(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {

		pharmacyService.updatePharmacy(ph);

		return new ModelAndView("redirect:/ofterUpdateuserListPharmacyDetail.html");

	}

	@RequestMapping(value = "/ofterUpdateuserListPharmacyDetail")
	public ModelAndView ofterUpdateuserListPharmacyDetail(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
		System.out.println("we are in showlist");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("ph", pharmacyService.listPharmacy());
		ArrayList<String> updateMsg = new ArrayList<String>();
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("ph") Pharmacy ph, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView viewStckDetails(@ModelAttribute("user") ProductType99 user, BindingResult result) {
	...
	public ModelAndView searchbyproduct(@ModelAttribute("user") ProductType99 user, BindingResult result) {
		...
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("user", stockService.GetParticularDetails(user.getProductTypeName()));
		model.put("names", names1);
		model.put("ptypes", ptypes1);
	...
	public ModelAndView searchbyptype(@ModelAttribute("user") ProductType99 user, BindingResult result) {
		...
		model.put("user", stockService.GetDetailsBasedonProductType(user.getType()));
		model.put("names", names1);
		System.out.println(model);
		return new ModelAndView("StockPosition", model);
	...
	public ModelAndView viewStckDetails2(@ModelAttribute("user") StockDetails user, BindingResult result) {
	...
	public ModelAndView editStockDetails2(@ModelAttribute("user") StockDetails user, BindingResult result) {
		System.out.println("am in update controller");
	...
	public ModelAndView updateUserData2(@ModelAttribute("user") StockDetails user, BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView getRegisterForm1(@ModelAttribute("user") StockDetails user, BindingResult result) {
		System.out.println("am in Product Search Controller");
	...
	public ModelAndView viewDuecustomwers1(@ModelAttribute("user") DuePatient user, BindingResult result) {
	...
	public ModelAndView deleteEmployee1(@ModelAttribute("user") DuePatient user, BindingResult result) {
		System.out.println("am in edit controller");
		System.out.println(user.getId());
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView updateUserData1(@ModelAttribute("user") DuePatient user, BindingResult result) {
	...
	public ModelAndView SearchPatient1(@ModelAttribute("user") DuePatient user, BindingResult result) {
		System.out.println(user.getAdmitdate());
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("user", duePatientService.getUserParticularDayDetails(user.getAdmitdate()));
		System.out.println("retriving user data Data");
		return new ModelAndView("DuePatient1", model);
	}
	...
	public ModelAndView search567(HttpServletRequest req, @ModelAttribute("user") Departmentpojo user,
			BindingResult result) {
	...
	public ModelAndView searchsd567(HttpServletRequest req, @ModelAttribute("user") Departmentpojo user,
			BindingResult result) {
	...
	public String saveUserData567(@Valid @ModelAttribute("user") Departmentpojo user, BindingResult result) {
		System.out.println("asaa");
		departmentService.saveUser(user);
		System.out.println(user.getDepartmentName());
		System.out.println(user.getId());
		System.out.println("Save User Data");
		ModelAndView m1 = new ModelAndView("locationInserted1");
		m1.addObject("abc", departmentService.getUser());
		return "redirect:indexxv1.html";
	}

	@RequestMapping("/DEPORT")
	public ModelAndView saveUserDatadfbvf567(@Valid @ModelAttribute("user") Departmentpojo user, BindingResult result) {
	...
	public ModelAndView retrive1567(HttpServletRequest http, HttpServletResponse response)
	...
	public ModelAndView updateUserData567(@Valid @ModelAttribute("user") Departmentpojo user, BindingResult result) {
	...
	public ModelAndView deletepatient567(@ModelAttribute("user") Departmentpojo user, BindingResult result) {
		List<MainDepartmentpojo> l1 = departmentService.getMaindepartment();
		ArrayList<String> na = new ArrayList();
		ArrayList<String> la = new ArrayList();
		Iterator<MainDepartmentpojo> i1 = l1.iterator();
	...
	public ModelAndView saveUserData567(@ModelAttribute("user") Locationpojo1 user, BindingResult result) {
		LocationService.addUser(user);
		System.out.println("Save User Data");
	...
	public ModelAndView retrive567(HttpServletRequest http, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public ModelAndView updateUserData567(@Valid @ModelAttribute("user") Locationpojo1 user, BindingResult result) {
	...
	public ModelAndView deletepatient567(@ModelAttribute("user") Locationpojo1 user, BindingResult result) {
		System.out.println("am in update controller");
		System.out.println(user.getId());
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView getRegisterForm() {
		...
		ModelAndView m = new ModelAndView("module3");
	...
	public ModelAndView saveUserData567(@Valid @ModelAttribute("user") PatientPojo user, BindingResult result) {
		System.out.println(user.getAddress());
		System.out.println(user.getTokenId());
		System.out.println(user.getTokenId());
		System.out.println(user.getTokenId());
		System.out.println(user.getTokenId());
		System.out.println(user.getTokenId());
	...
	public ModelAndView getDetailsOfPatientAppointMent(@Valid @ModelAttribute("user") PatientPojo user,
			BindingResult result) {
		List<Dcotcorpojo> l1 = userService.getdoctors();
	...
	public ModelAndView updateUserData567(@Valid @ModelAttribute("user") PatientPojo user, BindingResult result) {
		userService.updateUser(user);
		System.out.println("Save User Data");
		return new ModelAndView("success4");
	}

	@RequestMapping("/bca")
	public ModelAndView getUserList567(@ModelAttribute("user") PatientPojo user, BindingResult result) {
		List<Dcotcorpojo> l1 = userService.getdoctors();
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("abc", userService.getUserDetails());
		ArrayList<String> na = new ArrayList();
		...
		m2.addObject("abc", userService.getUserDetails());
		return m2;
	}

	@RequestMapping("/get")
	public ModelAndView getenquery567(@ModelAttribute("user") PatientPojo user, BindingResult result) {
	...
	public ModelAndView editpatient567(@ModelAttribute("command") PatientPojo user, BindingResult result) {
	...
	public ModelAndView deletepatient567(@ModelAttribute("command") PatientPojo user, BindingResult result) {
		System.out.println("am in update controller");
		System.out.println(user.getId());
		Map<String, Object> model = new HashMap<String, Object>();
		...
		gender.add("Male");
		gender.add("Female");
		model.put("user", (userService.getPatient(user.getId())));
		model.put("gender", gender);
		System.out.println(user.getId());
	...
	public ModelAndView retrive12567(HttpServletRequest http, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public ModelAndView index() {
		...
		m1.setViewName("registration");
		m1.addObject("ma", "Select");
		m1.addObject("india", "Select");
	...
	public ModelAndView duplicate(@ModelAttribute("patient") AddPatient1 document, HttpServletRequest req,
			HttpSession hht) {
	...
	public String saveLoginData(@ModelAttribute("patient") AddPatient1 document, HttpServletRequest req,
			HttpSession hht) {
	...
	public ModelAndView saveLoginDataSDG(@ModelAttribute("patient") AddPatient1 document, HttpServletRequest req,
			HttpSession hht) {

		ModelAndView m1 = new ModelAndView("success567");
		m1.addObject("abc", patientservice12045.getpatients());
	...
	public ModelAndView retrive(HttpServletRequest http, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public ModelAndView duplicateedit(@ModelAttribute("patient") AddPatient1 document, HttpServletRequest req,
			HttpSession hht) {
	...
	public ModelAndView update(@ModelAttribute("patient1") AddPatient1 document, HttpServletRequest re,
			HttpSession hht) {
	...
	public ModelAndView add(@ModelAttribute("patient") AddPatient1 document) {
		...
		m1.addObject("abc", l1 = patientservice12045.getpatients());
		for (AddPatient1 addPatient1 : l1) {
			i += 1;
		}
	...
	public ModelAndView serrchpatient(HttpServletRequest http, HttpServletResponse response)
			throws SQLException, IOException {
	...
	public ModelAndView serrchpatientf(HttpServletRequest http, HttpServletResponse response)
			throws SQLException, IOException {
		String username = http.getParameter("mrno");
		String regno = http.getParameter("pname");
	...
	public ModelAndView outconsult() {
		...
		String[] stockArr45 = new String[] { "  regional  ", "  consult  ", "Others" };
	...
	public String saveOutconsult(@ModelAttribute("outconsult") OutsideConultPojo document1, HttpServletRequest req,
			HttpSession hht) {
	...
	public ModelAndView saveOutconsulttrh(@ModelAttribute("outconsult") OutsideConultPojo document1,
	...
	public ModelAndView EDITOutconsult(@ModelAttribute("outconsult") OutsideConultPojo document1,
			HttpServletRequest req, HttpSession hht) {
	...
	public ModelAndView updateOutconsult(@ModelAttribute("outconsult") OutsideConultPojo document1,
			HttpServletRequest req, HttpSession hht) {
	...
	public ModelAndView deleteOutconsult(@ModelAttribute("outconsult") OutsideConultPojo document1,
			HttpServletRequest req, HttpSession hht) {
	...
	public ModelAndView searchOutconsult(@ModelAttribute("outconsult") OutsideConultPojo document1,
			HttpServletRequest req, HttpSession hht) {
	...
	public ModelAndView addmlcpati() {
		...
		String[] stockArr45 = new String[] { "  Male  ", "  Female  " };
		ModelAndView m1 = new ModelAndView("MLCadd2");
	...
	public String savemlc(@ModelAttribute("mlcpatient") Mlcpojo document, @RequestParam("file") MultipartFile file,
			@RequestParam("file1") MultipartFile file1, @RequestParam("file2") MultipartFile file2,
			@RequestParam("file3") MultipartFile file3) throws IOException, ServletException {
		...
		try {
			...
			byte[] imgData1 = file1.getBytes();
			byte[] imgData2 = file2.getBytes();
			byte[] imgData3 = file3.getBytes();
			...
			document.setPatientPhoto(imgData);
			document.setxRayreports(imgData1);
			document.setScanReports(imgData2);
			document.setOtherReports(imgData3);
	...
	public ModelAndView search(HttpServletRequest http, HttpServletResponse response) throws SQLException, IOException {
		String username = http.getParameter("name");
		String regno = http.getParameter("regno");
		String date = http.getParameter("date");
	...
	public ModelAndView EDITmlcpatient(HttpServletRequest req, HttpSession sessss) {
		...
		ModelAndView m1 = new ModelAndView("MLCEdit2121");
		m1.addObject("abc", l1);
		m1.addObject("radiobutt", stockArr45);
		m1.addObject("sex", mf);
	...
	public ModelAndView updatemlc(@ModelAttribute("updatemlcpatient") Mlcpojo document,
			...
			HttpServletRequest req, HttpSession sessss) throws IOException, ServletException {
	...
	public ModelAndView serrchpatiensegt(HttpServletRequest http, HttpServletResponse response)
			throws SQLException, IOException {
		String username = http.getParameter("mrno");
		String regno = http.getParameter("pname");
		...
		if (username != "" && regno != "") {
			System.out.println("bhai");
			mv.addObject("abc", l1 = outpatientService.getpatientbyreno(username));
	...
	public ModelAndView form(@ModelAttribute("inp") entry inp, BindingResult result) {
	...
	public ModelAndView page(@ModelAttribute("inp") entry inp, BindingResult result, HttpServletRequest request,
...
*/
	...
	public String gr(@ModelAttribute("inp") entry inp, BindingResult result, @ModelAttribute("inp1") Patientdetail inp1,
			HttpSession ses) {
		...
		inp.setPatientname(patientname);
		String patientData = (String) ses.getAttribute("regdate");
		inp.setRegdate(patientData);
		String roomn1 = (String) ses.getAttribute("rooms");
		inp.setRoomno(roomn1);
		String roomr1 = (String) ses.getAttribute("roomrents");
		/* inp.setRoomno(roomr1); */
		inp.setRoomrent(roomr1);
	...
	public ModelAndView grsdfgsdrgsdr(@ModelAttribute("inp") entry inp, BindingResult result,
			@ModelAttribute("inp1") Patientdetail inp1) {
	...
	@RequestMapping("/updatedinpatient")
	public ModelAndView updatepatient12(@ModelAttribute("inp") entry inp, BindingResult result, HttpServletRequest req,
			HttpSession sess) {
		...
		ModelAndView m2 = new ModelAndView("InPatientupdate");
		...
		m2.addObject("rooms", roomn1);
		m2.addObject("roomrents", roomr1);

		/*
		 * sess.setAttribute("rooms",roomn1);
		 * sess.setAttribute("roomrents",roomr1);
		 */
	...
	public ModelAndView search1(HttpServletRequest request, HttpServletRequest response,
			@ModelAttribute("inp") entry inp, BindingResult result) {
	...
	@RequestMapping(value = "/updatedatainpatient", params = { "updating" })
	public ModelAndView saveUserUpdate(@ModelAttribute("inp") entry inp, BindingResult result, HttpSession ses) {
		System.out.println(inp.getPatientmrno());
		System.out.println(inp.getId());
		si.addUserUpdate(inp);
		String roomn1 = (String) ses.getAttribute("rooms");
		inp.setRoomno(roomn1);
		String roomr1 = (String) ses.getAttribute("roomrentspatient");
		inp.setRoomrent(roomr1);
		System.out.println(inp.getPatientmrno());
		System.out.println(inp.getPatientname());
		ModelAndView mav = new ModelAndView("InPatientAdSuccess");
	...
	public ModelAndView up(@ModelAttribute("inp") entry inp, BindingResult result, HttpServletRequest req,
			HttpSession sess) {
	...
	public ModelAndView pagsdsdfe(@ModelAttribute("inp") entry inp, BindingResult result, HttpServletRequest request,
...
*/
		...
		List<Patientdetail> patient = si.getDetailspatient(inp.getPatientmrno());
		...
		for (Beddata patientdetail : pat) {
			roomn1 = patientdetail.getRoomno();
			roomr1 = patientdetail.getRoomrent();
			System.out.println(bed + " " + roomn1 + " " + roomr1);
		}
...
/*		sess.setAttribute("rooms", roomn1);
	...
	public ModelAndView first(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result) {
		System.out.println("Doctor information page");
	...
	public ModelAndView addbtn(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result) {
		System.out.println("Doctor information add page");
	...
	@RequestMapping("/save")
	public ModelAndView doctordisplay(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result) {
	...
	public ModelAndView redirect(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result) {

		ModelAndView m2 = new ModelAndView("DoctorInfo1");
		m2.addObject("abc", doctorservice.getdoctors());
		return m2;
	}

	@RequestMapping("/doctorsearch.html")
	public ModelAndView doctorsearch(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result,
	...
	public ModelAndView updateex(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result,
			HttpServletRequest req) {
	...
	public ModelAndView saveUserUpdate(@ModelAttribute("doctor") Doctordetail doctor,
	...
	public ModelAndView deletecontent(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result) {
	...
	public ModelAndView deletedAfter(@ModelAttribute("doctor") Doctordetail doctor, BindingResult result) {
		System.out.println("iam in deleted controller");
	...
	public ModelAndView generateSupplierrReport(@ModelAttribute("user") ProductType99 user, BindingResult result,
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/SriLakshmiSuperSplhospital", "root",
					"root");
	...
	private JasperReport getCompiledFile(String fileName, HttpServletRequest request) throws JRException {
		...
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName1 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName1 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName1 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName1 + ".jasper"));
	...
	public ModelAndView generatevendorReport(@ModelAttribute("s") Supplier s, @ModelAttribute("user1") Hospital user1,
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile1(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile1(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
	...
	public String generateSalesReport(
			...
			@ModelAttribute("user") SalesEntryPojo user, BindingResult result, Model model, HttpServletRequest request,
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile2(reportFileName, request);
	...
	private JasperReport getCompiledFile2(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName2 + ".jasper"));
		// If compiled file not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName2 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName2 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName2 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateDuePatientReport(@ModelAttribute("user") DuePatient user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile3(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile3(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName3 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName3 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName3 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName3 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateTarrifReport(@ModelAttribute("tarrif") RoomTarrif tarrif, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile4(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile4(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName4 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName4 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName4 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName4 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateProductReport(@ModelAttribute("pd") ProductDetail pd,
			@ModelAttribute("user1") Hospital user1, BindingResult result, Model model, HttpServletRequest request,
			HttpServletResponse response) throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile5(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile5(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName5 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName5 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName5 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName5 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generatePatientReport(@ModelAttribute("user") PatientPojo user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			HashMap<String, Object> hmParams = new HashMap<String, Object>();
			hmParams.put("doctName", user.getDoctorName());
			hmParams.put("aptDate", user.getAppointmentDate());

			System.out.println(hmParams);

			JasperReport jasperReport = getCompiledFile6(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile6(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName6 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName6 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName6 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName6 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateInPatientReport(@ModelAttribute("user") InpatientPojo user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile7(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile7(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName7 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName7 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName7 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName7 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateDoctorReport(@ModelAttribute("user") Doctordetail user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledFile8(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledFile8(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName8 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName8 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName8 + ".jasper"));
		}
		System.out.println("ofter compilation");
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName8 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView ShowSalesEntrylist(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView SearchPatient(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		System.out.println(salesEntryPojo.getSalesDate());
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("user", salesEntryService.getUserParticularDayDetails(salesEntryPojo.getSalesDate()));
		System.out.println("retriving user data Data");
		return new ModelAndView("saleslist", model);
	}

	@RequestMapping("/salesEntryFirstDetailsOFSalesEntry")
	public ModelAndView getRegisterForm(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {

		ArrayList<String> customerType = new ArrayList<String>();
		customerType.add(" " + "Customer" + " ");
		customerType.add(" " + "Patient" + " ");
	...
	public ModelAndView getparticularproductDetails(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		...
		model.put("productRelatedDetails", salesEntryService.getProductRelateddetails(salesEntryPojo));
		model.put("getAddingProductDetails", salesEntryService.getAddingProductDetails());
		System.out.println(model);
	...
	public ModelAndView getparticularproductDetailsADD(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView closeSalesEntrydetails(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView totalbilling(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView deleteSalesEntry(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView returnslistdetails(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
	...
	public ModelAndView returnslistdetailsName(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
		...
		model.put("details", salesReturnsService.getdetailsOfsalesReturnsName(salesEntryPojo));
		model.put("names", names1);
		System.out.println(model);
		return new ModelAndView("salesReturnsListDetails", model);
	}
	...
	public ModelAndView getRegisterForm2(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		...
		ArrayList<String[]> productnameDb = new ArrayList<String[]>();
		productnameDb.add(salesReturnsService.getCustomerName());
	...
	public ModelAndView getparticularproductDetails2(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		...
		qty.add(salesReturnsService.getQty(salesEntryPojo.getProductName(),salesEntryPojo.getName()));
		...
		model.put("totalAmount", totalAmount);
		System.out.println(salesEntryPojo.getProductName());
		model.put("productRelatedDetails", salesReturnsService.getProductRelateddetails(salesEntryPojo));
		model.put("getAddingProductDetails", salesReturnsService.getAddingProductDetails());

		model.put("salesEntryPojogettingnames", salesReturnsService.getsalesPersonNames(salesEntryPojo.getName()));
	...
	public ModelAndView getparticularproductDetailsADD2(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView totalbilling2(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView cancessalesReturnsdetails(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView deleteSalesRetursListDetails(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
		System.out.println("am in delete controller");
		System.out.println(salesEntryPojo.getSalesid());
	...
	public ModelAndView getProductdetailsName2(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result) {
	...
	public ModelAndView viewStckDetails(
			@ModelAttribute("purchaseInvoiceePojo") PurchaseInvoiceePojo purchaseInvoiceePojo, BindingResult result) {
	...
	public ModelAndView viewStckDetailsi(
		...
		ricivedby.add("Admin");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("user", purchaseInvoiceService.GetDetailsOfSuplierDetails(purchaseInvoiceePojo.getSupplierName()));
		System.out.println(model);
		return new ModelAndView("purchaselist1", model);
	}
	...
	public ModelAndView getSupplierDetails(
		...
		supplierAddress.add(purchaseInvoiceService.getsupplierAddress(purchaseInvoiceePojo));
		ArrayList<String> supplierCity = new ArrayList<String>();
		supplierCity.add(purchaseInvoiceService.getsupplierCity(purchaseInvoiceePojo));
		ArrayList<String> SupplierName = new ArrayList<String>();
		...
		model.put("getProductDetails", purchaseInvoiceService.getgetProductDetails());
		System.out.println(model);
	...
	public ModelAndView getproductDetails(
		...
		ArrayList<String> supplierAddress = new ArrayList<String>();
		supplierAddress.add(purchaseInvoiceService.getsupplierAddress(purchaseInvoiceePojo.getSupplierName()));
		ArrayList<String> supplierCity = new ArrayList<String>();
		supplierCity.add(purchaseInvoiceService.getsupplierCity(purchaseInvoiceePojo.getSupplierName()));
		ArrayList<String> SupplierName = new ArrayList<String>();
		SupplierName.add(purchaseInvoiceePojo.getSupplierName());
	...
	@RequestMapping(value = "/cancelPurchaseInvoicedetilas", params = { "total" })
	...
	public ModelAndView puchaseReturnsListFirst(
		...
		ArrayList<String[]> supplierName = new ArrayList<String[]>();
		supplierName.add(purchaseInvoiceReturnsService.getSuppliernameDetails());
		ArrayList<String> supplierNameDb = new ArrayList<String>();
		for (String[] s : supplierName) {
			int i = s.length;
			for (int j = 0; j < i; j++) {
		...
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("purchaseReturnList", purchaseInvoiceReturnsService.getPurchaseReturnsList());
		model.put("supplierNameDb", supplierNameDb);
		System.out.println(model);
	...
	public ModelAndView searchBySupplierName(
		...
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("purchaseReturnList", purchaseInvoiceReturnsService.getListBySupplierName(purchaseInvoiceePojo));
		model.put("supplierNameDb", supplierNameDb);
		System.out.println(model);
		return new ModelAndView("PurchaseReturnList", model);
	}
	...
	public ModelAndView getRegisterForm(
		...
		ArrayList<String[]> productName = new ArrayList<String[]>();
		productName.add(purchaseInvoiceReturnsService.getProductname(purchaseInvoiceePojo));
	...
	public ModelAndView getSupplierDetails(
		...
		ArrayList<String> supplierAddress = new ArrayList<String>();
		supplierAddress.add(purchaseInvoiceReturnsService.getsupplierAddress(purchaseInvoiceePojo));
		ArrayList<String> supplierCity = new ArrayList<String>();
		supplierCity.add(purchaseInvoiceReturnsService.getsupplierCity(purchaseInvoiceePojo));
		ArrayList<String> SupplierName = new ArrayList<String>();
		SupplierName.add(purchaseInvoiceePojo.getSupplierName());

		ArrayList<String> purchaseTypegetting = new ArrayList<String>();
		purchaseTypegetting.add(purchaseInvoiceReturnsService.purchaseTypegetting(purchaseInvoiceePojo));
		ArrayList<String> invoicenumber = new ArrayList<String>();
		invoicenumber.add(purchaseInvoiceReturnsService.invoicenumber(purchaseInvoiceePojo));
		ArrayList<String> invoiceDate = new ArrayList<String>();
		invoiceDate.add(purchaseInvoiceReturnsService.invoiceDate(purchaseInvoiceePojo));
		ArrayList<String> purchaseDate = new ArrayList<String>();
		purchaseDate.add(purchaseInvoiceReturnsService.purchaseDate(purchaseInvoiceePojo));
		...
		model.put("supplierCity", supplierCity);
		model.put("SupplierName", SupplierName);
		model.put("getProductDetails", purchaseInvoiceReturnsService.getgetProductDetails());
	...
	public ModelAndView getproductDetails(
		...
		System.out.println("im in add");
		ArrayList<String> supplierAddress = new ArrayList<String>();
		supplierAddress.add(purchaseInvoiceReturnsService.getsupplierAddress(purchaseInvoiceePojo.getSupplierName()));
		ArrayList<String> supplierCity = new ArrayList<String>();
		supplierCity.add(purchaseInvoiceReturnsService.getsupplierCity(purchaseInvoiceePojo.getSupplierName()));
		ArrayList<String> SupplierName = new ArrayList<String>();
		SupplierName.add(purchaseInvoiceePojo.getSupplierName());
		...
		purchaseInvoiceReturnsService.saveParticularproducts(purchaseInvoiceePojo);
	...
	public ModelAndView deletePurchaseInvoiceReturnsListDetails(
		...
		supplierNameDetailsOs.add(purchaseInvoiceReturnsService.supplierNameDetailsOs(purchaseInvoiceePojo.getPurchaseId()));
		...
		purchaseInvoiceReturnsService.deleteDetailsOf(purchaseInvoiceePojo.getPurchaseId());
	...
	public ModelAndView getproductParticularDetails(
		...
		manufacturingBy.add(purchaseInvoiceReturnsService.getproductmanufacturingBy(
				purchaseInvoiceePojo.getSupplierName(), purchaseInvoiceePojo.getProductName()));
		ArrayList<Double> vat = new ArrayList<Double>();
		vat.add(purchaseInvoiceReturnsService.getVat(purchaseInvoiceePojo.getSupplierName(),
				purchaseInvoiceePojo.getProductName()));
		ArrayList<Double> rate = new ArrayList<Double>();
		rate.add(purchaseInvoiceReturnsService.getrate(purchaseInvoiceePojo.getSupplierName(),
				purchaseInvoiceePojo.getProductName()));
		ArrayList<String> batchNo = new ArrayList<String>();
		batchNo.add(purchaseInvoiceReturnsService.getBatchNo(purchaseInvoiceePojo.getSupplierName(),
				purchaseInvoiceePojo.getProductName()));

		ArrayList<Double> quantity = new ArrayList<Double>();
		quantity.add(purchaseInvoiceReturnsService.getQuantity(purchaseInvoiceePojo.getSupplierName(),purchaseInvoiceePojo.getProductName()));
	...
	public ModelAndView RoomsRegistarion(@ModelAttribute("room") RoomPojo room, BindingResult result) {
	...
	public ModelAndView RoomsRegistarionSave(@ModelAttribute("room") RoomPojo room, BindingResult result) {
		...
		message.add("RECORD INSERTED SUCCESSFULLY");
	...
	public ModelAndView rePageDetails(@ModelAttribute("room") RoomPojo room, BindingResult result) {
	...
	public ModelAndView AddDetails(@ModelAttribute("room") RoomPojo room, BedDetails deails, BindingResult result) {
		Map<String, Object> model = new HashMap<String, Object>();
		ArrayList<String[]> locations = new ArrayList<String[]>();
		locations.add(bedDetailsService.getFloors());
	...
	public ModelAndView beddetailsAddDetails(@ModelAttribute("room") RoomPojo room, BedDetails deails,
			BindingResult result) {

		System.out.println("am in add controller");

		bedDetailsService.savesubtotal(room);
		...
		model.put("roomDetails", bedDetailsService.getRoomDetails(room.getFloorname(), room.getRoomno()));
	...
	public ModelAndView totalSubmit(@ModelAttribute("room") RoomPojo room, BedDetails deails, BindingResult result) {
	...
	public ModelAndView FirsttotalSubmit(@ModelAttribute("room") RoomPojo room, BedDetails deails,
			BindingResult result) {
	...
	public ModelAndView bedDetailsCancel(@ModelAttribute("room") RoomPojo room, BedDetails deails,
			BindingResult result) {
	...
	public ModelAndView beddetailsAddDetailsParticularRooms(@ModelAttribute("room") RoomPojo room, BedDetails deails,
			BindingResult result) {
	...
	public ModelAndView getRoomDetails(@ModelAttribute("room") RoomPojo room, BedDetails deails, BindingResult result) {
	...
	public ModelAndView generateSalesEntry(@ModelAttribute("user") SalesEntryPojo user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			System.out.println(user.getSalesDate());
			System.out.println(user.getSalesDate());
	...
	private JasperReport getCompiledFil(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileNam + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNam + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNam + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileNam + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generatePurchaseInvoiseReport(@ModelAttribute("user") PurchaseInvoiceePojo user,
			BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response)
			throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledPurchaseinvoise(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams9, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledPurchaseinvoise(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName9 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName9 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName9 + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName9 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generatePurchasereturnsrepport(@ModelAttribute("user") PurchaseInvoiceeReturns user,
			BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response)
			throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledPurchasereturns(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams10, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledPurchasereturns(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName10 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName10 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName10 + ".jasper"));
		}
		System.out.println("ofter compilation");
	...
	public ModelAndView generatePurchaseInvoise(@ModelAttribute("user") PurchaseInvoiceePojo user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			System.out.println(user.getId());
			System.out.println(user.getId());
			System.out.println(hmParams11);

			JasperReport jasperReport = getCompiledPurchaseInvoise(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams11, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledPurchaseInvoise(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName11 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName11 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName11 + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName11 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams11, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateInpatientDetails(@ModelAttribute("user") entry user, BindingResult result, Model model,
		...
		try {
			...
			System.out.println(user.getId());
			System.out.println(user.getId());
			System.out.println(hmParams12);

			JasperReport jasperReport = getCompiledInvoiseDetails(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams12, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledInvoiseDetails(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName12 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName12 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName12 + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName12 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams12, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateOutSideConsult(@ModelAttribute("user") Mlcpojo user, BindingResult result, Model model,
			HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			System.out.println(hmParamsi);
			System.out.println(user.getId());
			System.out.println(user.getId());
			System.out.println(user.getId());
			System.out.println(user.getId());
			JasperReport jasperReport = getCompiledoutSideConsult(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsi, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledoutSideConsult(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName13 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName13 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName13 + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName13 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsi, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateMlcReport(@ModelAttribute("user") OutsideConultPojo user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getCompiledMlcReport(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParams, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getCompiledMlcReport(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileName14 + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName14 + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileName14 + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileName14 + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generatePatentRegistrationReport(@ModelAttribute("user") AddPatient1 user, BindingResult result,
			Model model, HttpServletRequest request, HttpServletResponse response) throws ParseException {
		...
		try {
			...
			System.out.println(hmParamsp);
			System.out.println(user.getRegistNo());
			System.out.println(user.getRegistNo());
			System.out.println(user.getRegistNo());
			System.out.println(user.getRegistNo());
			JasperReport jasperReport = getPatientRegistration(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsp, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getPatientRegistration(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileNamep + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNamep + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNamep + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileNamep + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsp, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateSalesReportByIdReport(@ModelAttribute("salesEntryPojo") SalesEntryPojo salesEntryPojo,
			BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response)
			throws ParseException {
		...
		try {
			...
			System.out.println(salesEntryPojo.getSalesid());
			System.out.println(salesEntryPojo.getSalesid());
			JasperReport jasperReport = getSalesEntryReportById(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsid, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getSalesEntryReportById(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileNameid + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNameid + ".jrxml"),
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNameid + ".jasper"));
		}
		System.out.println("ofter compilation");
		...
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile.getPath());
		System.out.println(
				"path " + request.getSession().getServletContext().getRealPath("/jasper/" + fileNameid + ".jasper"));
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsid, conn);
		JasperViewer.viewReport(jasperPrint, false);
	...
	public ModelAndView generateReturnsReport(@ModelAttribute("salesEntryPojo") SalesEntryReturns salesEntryPojo,
			BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response)
			throws ParseException {
		...
		try {
			...
			JasperReport jasperReport = getSalesReturnsReport(reportFileName, request);
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, hmParamsSalesReturns, conn);
			// For HTML report
		} catch (Exception sqlExp) {
	...
	private JasperReport getSalesReturnsReport(String fileName, HttpServletRequest request) throws JRException {
		System.out.println("before compilation");
		File reportFile = new File(
				request.getSession().getServletContext().getRealPath("/jasper/" + fileNameSalesReturns + ".jasper"));
		// If compiled file is not found, then compile XML template
		if (!reportFile.exists()) {
			JasperCompileManager.compileReportToFile(
					request.getSession().getServletContext().getRealPath("/jasper/" + fileNameSalesReturns + ".jrxml"),
	...
	public ModelAndView getRegisterForm(@ModelAttribute("user") Employee user, BindingResult result) {
		ArrayList<String> gender = new ArrayList<String>();
		gender.add("Male");
		gender.add("Female");
	...
	public ModelAndView saveUserData(@ModelAttribute("user") Employee user, @RequestParam("file") MultipartFile file) {

		System.out.println("am in save controller");
		...
		System.out.println();
		System.out.println();
		System.out.println("am after try block in controller");
		System.out.println();
		System.out.println("content  = " + user.getContent());
		System.out.println("File:" + file.getName());
		System.out.println("ContentType:" + file.getContentType());
	...
	public ModelAndView conformRegister(@ModelAttribute("user") Employee user, BindingResult result) {
		ArrayList<String> gender = new ArrayList<String>();
		gender.add("Male");
		gender.add("Female");
		ArrayList<String> state = new ArrayList<String>();
		...
		ArrayList<String> msg = new ArrayList<String>();
		msg.add("User Successfully Registerd");
		model.put("msg", msg);
	...
	public ModelAndView seeImageEmployee(@ModelAttribute("user") Employee user, HttpServletResponse response,
	...
	public ModelAndView SupplierTypeAdd(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
	...
	@RequestMapping("/updateSupplierType")
	public ModelAndView SupplierTypeAddParticularType(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
		
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("asdf",supplierService.GetDetailsOfSupplierByType(asdf.getSupplierType()));
		return new ModelAndView("EditSupplierType",model);
	}	
	

	@RequestMapping("/addSupplierType")
	public ModelAndView SupplierTypeAddPPagwParticularType(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
	...
	public ModelAndView SupplierTypeSaveAddParticularType(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
	...
	public ModelAndView supplierTypeSuccessList(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
	...
	public ModelAndView supplierTypeUpdateSuccessList(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
	...
	public ModelAndView SupplierTypeEditAddParticularType(@ModelAttribute("asdf") NewSupplierInfoPojo asdf, BindingResult result) {
		
		boolean b=supplierService.editSupplierTypeDetAILs(asdf);
		if(b){
		return new ModelAndView("redirect:/supplierTypeUpdateSuccessList.html");
		}else{
			Map<String, Object> model = new HashMap<String, Object>();
			model.put("asdf",supplierService.GetDetailsOfSupplierByType(asdf.getSupplierType()));
			ArrayList<String> msg = new ArrayList<String>();
